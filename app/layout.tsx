...
import { Calendar, Users, Hospital, Stethoscope, Warehouse, CircleDollarSign, Settings, LogOut, Menu, X, Home } from 'lucide-react'
...
export function Layout() {
  ...
  const menuItems = [
    ...
    { icon: Hospital, label: 'Salas', path: '/dashboard/salas' },
    { icon: Stethoscope, label: 'Médicos', path: '/dashboard/medicos' },
